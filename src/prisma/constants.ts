...
export const users = [
  {
    fullName: "Дережабль Созвездия",
    email: "starkaptan@gmail.com",
  ...
  {
    fullName: "Admin User",
    email: "amdinuser@gmail.com",
    password: hashSync("332233", 10),
    verified: new Date(),
    role: UserRole.ADMIN
  }
];
...
export const pizzas = [
  ...
  },
  {
    ...
    categoryId: 1,
    ingredients: ingredients.slice(10, 40),
  },
]
...
export const cartItems = [
  {
    ...
    cartId: 1,
    quantity: 2,
    ingredients: [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 6 }]
  },
]

export const truncateListModels = ["User", "Category", "Product", "ProductVariation", "Ingredient", "CartItem", "Cart"];